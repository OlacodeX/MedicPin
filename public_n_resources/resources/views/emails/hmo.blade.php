...
@endphp
# Hello,
# Dear administrator at {{$hmo->hmo_org_name}},

 <p>This is to notify you that a patient here on medicpin has requested that you settle their bills on medicpin. <br>
     Below are the patient's details: </p>
 <p>Name: {{auth()->user()->name}}</p>
 <p>Email: {{auth()->user()->email}}</p>
 <p>MedicPin: {{auth()->user()->pin}}</p>
 <p>Kindly head on to your dashboard to validate or reject claim.</p>
<br><br>
<p>Warm Regards,</p>
