        ...
        <div class="">
           <div class="row">
            <div class="form-group col-md-12">
             ...
             <h6>Patient On MedicPin? Enter Pin and We Will Get Their Details From Our Records</h6>
            </div>
         </div>
         <div class="iq-card-body">
             ...
             <input type="text" class="form-control" id="pin" name="pin" placeholder="Patient MedicPin">
             </div>
             </div>
            </div>
         </div>
            <button type="submit" class="btn btn-primary" style="margin-left: 20px;">Add Patient</button>
            {!! Form::close() !!}
            </div>
            </div>
            <hr>
                       ...
                       <div class="iq-card-body">
                          <div class="new-user-info">
                                <div class="row">
                                   ...
                                   <div class="form-group col-md-6">
                                      <label for="mobno">Country Code:</label>
