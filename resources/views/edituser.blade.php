   ...
   <div class="container-fluid">
      <div class="row align-items-center">
         <div class="col-md-12 col-12">
            ...
            <h2 class="breadcrumb-title">Update Details</h2>
         </div>
      </div>
   </div>
</div>
...
<div class="card">
 <div class="card-header">
    <div class="card-title">
       <h4 class=""><b>Update User Information</b> </h4>
    </div>
 </div>
 <div class="card-body">
          ...
          <div class="row">
             ...
             <div class="form-group col-md-6">
              ...
              <div class="form-group col-md-6">
                 ...
                 <div class="inner-addon right-addon">
                     ...
                     <input id="twitter" type="text" class="form-control mb-0 @error('twitter') is-invalid @enderror" name="twitter" value="{{ $user->twitter }}" autocomplete="twitter" placeholder="Your Twitter Username">
             ...
             <div class="form-group col-md-6">
                 ...
                 <div class="inner-addon right-addon">
                     ...
                     <input id="facebook" type="text" class="form-control mb-0 @error('facebook') is-invalid @enderror" name="facebook" value="{{ $user->facebook }}" autocomplete="facebook" placeholder="Your Facebook Username">
              ...
              <div class="form-group col-md-6">
               ...
               @endphp
                 <div class="form-group col-md-6">
                   ...
                   <div class="inner-addon right-addon">
                       ...
                       <input id="username" type="text" class="form-control mb-0 @error('username') is-invalid @enderror" name="username" value="{{ $nok->username }}" autocomplete="username" placeholder="Your username">
               ...
               <div class="form-group col-md-6">
                 ...
                 <div class="inner-addon right-addon">
                     <i class="fa fa-occupation"></i>
                     
                     <input id="occupation" type="text" class="form-control mb-0 @error('occupation') is-invalid @enderror" name="occupation" value="{{ $nok->occupation }}" autocomplete="occupation" placeholder="What do for a living?">
                 ...
                 <div class="form-group col-md-6">
                   ...
                   <div class="inner-addon right-addon">
                       ...
                       <input id="add" type="text" class="form-control mb-0 @error('add') is-invalid @enderror" name="add" value="{{ $nok->address }}" autocomplete="add" placeholder="Your address">
               ...
               <div class="form-group col-md-6">
                 ...
                 <div class="inner-addon right-addon">
                     <i class="fa fa-"></i>
                         <input type="text" class="form-control mb-0" name="children" id="children" style="display: none;" value="{{ $user->children }}" placeholder="Number of children if applicable">
               ...
               <div class="form-group col-md-6">
                 <label for="Expertise">Expertise:</label>
                  <select class="form-control mb-0" id="selectex" name="expertise">
                    @if ($user->expertise == '' || $user->expertise == 'select')
           ...
           <div class="inner-addon right-addon">
               ...
               <h5 class="text-justify">Next Of Kin Details</h5>
              </div>
               <div class="form-group col-md-6">
                  <label for="nok">Name</label>
                  <div class="inner-addon right-addon">
                      <i class="fa fa-user"></i>
                      <input type="text" class="form-control mb-0" name="nok" value="{{$nok->nok}}"  placeholder="Next of Kin name">
                  </div>
              </div>
              <div class="form-group col-md-6">
                  ...
                  <div class="inner-addon right-addon">
                      ...
                      <input type="number" class="form-control mb-0" name="nokp" id="nokp" value="{{$nok->nok_phone}}" placeholder="Next of Kin phone number">
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="inner-addon right-addon">
                        ...
                        <input type="text" class="form-control mb-0" name="nok_relation" value="{{$nok->nok_relation}}"  placeholder="Relationship With Next of Kin">
