               ...
               <div class="navbar-breadcrumb">
                  ...
                  <nav aria-label="breadcrumb">
                     <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="../notifications">Notifications</a></li>
                         ...
                         @if (auth()->user()->role == 'Patient')
                             <li class="breadcrumb-item active" aria-current="page">Dr. {{$notice->from_name}}</li>
                            
                         @endif
                       
                         @if (auth()->user()->role == 'Doctor')
                             <li class="breadcrumb-item active" aria-current="page">{{$notice->to_name}}</li>
                ...
                <nav class="navbar navbar-expand-lg navbar-light p-0">
                                 ...
                                 <div class="iq-card-body p-0 ">
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 " src="images/user/01.jpg" alt="">
                                          </div>
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 " src="images/user/02.jpg" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 " src="images/user/03.jpg" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 " src="images/user/04.jpg" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 " src="images/user/05.jpg" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                  ...
                  <ul class="navbar-list">
                     <li>
                        <a href="#" class="search-toggle iq-waves-effect bg-primary text-white"><img src="../images/user/1.jpg" class="img-fluid " alt="user"></a>
