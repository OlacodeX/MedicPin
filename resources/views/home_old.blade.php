                 ...
                 .right-addon .fa { right: 20px;}
                          ...
                          <span class="user-list-files d-flex float-right">
                           ...
                           {!!Form::close()!!} 
                             ...
                             <button type="submit" class ="btn btn-info btn-sm br" data-toggle="tooltip" data-placement="top" data-original-title="Add Hospital To HMO"><i class="ri-home-8-fill"></i>Add Hospital To HMO</button>
                           ...
                           <div class="Products">
                              <ul class="product_list gridcount grid row">
                                 ...
                                 <li class="product_item col-xs-12 col-sm-6 col-md-6 col-lg-4" style="list-style: none;">
                                    <a href="javascript:{}" onclick="document.getElementById({{$cat->id}}).submit();">
                                    ...
                                    <div class="product-miniature">
                                       <div class="thumbnail-container">
                                         <img src="{{ URL::to('img/hmo/cat/'.$cat->img)}}" alt="product-image" class="img-fluid tp" />                                           
                                       </div>
                                    </a>
                                       <style>
                                           span.pull-right{
                                ...
                                padding: 0;
                                       ...
                                       <div class="product-description">
                                          <h4>
                                             ...
                                             <button type="submit" class ="btn btn-info btn-sm center" data-toggle="tooltip" data-placement="top" data-original-title="Add package to category.">Add Package(s)</button>
                                                </div>
                                             {!!Form::close()!!}
                                          </h4> 
                              ...
                              <thead>
                                 <tr>
                                  <th scope="col">MedicPin</th>
                                    ...
                                    <th scope="col">Package On</th>
                                    <th scope="col">Package Limit</th>
                                    <th scope="col">Package Limit Remaining</th>
                                    <!---
                                    <th scope="col">Action</th>--->
                  ...
                  <div class="row">
                        ...
                        <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                           <div class="iq-card-body iq-bg-primary rounded">
                              <div class="d-flex align-items-center justify-content-between">
                                 <div class="rounded-circle iq-card-icon bg-primary"><i class="ri-user-fill"></i></div>
                                 <div class="text-right">                                 
                                    <h2 class="mb-0"><span class="counter">{{App\User::where('role', 'Doctor')->count()}}</span></h2>
                                    <h5 class="">Doctors</h5>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                           <div class="iq-card-body iq-bg-primary rounded">
                              <div class="d-flex align-items-center justify-content-between">
                                 ...
                                 <div class="text-right">                                 
                                    <h2 class="mb-0"><span class="counter">{{ App\User::where('role', 'Nurse')->count()}}</span></h2>
                                    <h5 class="">Nurses</h5>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                           <div class="iq-card-body iq-bg-primary rounded">
                              <div class="d-flex align-items-center justify-content-between">
                                 <div class="rounded-circle iq-card-icon bg-primary"><i class="ri-user-fill"></i></div>
                                 <div class="text-right">                
                                    <h2 class="mb-0"><span class="counter">{{ App\User::where('role', 'Patient')->count()}}</span></h2>
                     ...
                     <div class="col-md-6 col-lg-3">
                        <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                           <div class="iq-card-body iq-bg-primary rounded">
                              <div class="d-flex align-items-center justify-content-between">
                                 <div class="rounded-circle iq-card-icon bg-primary"><i class="ri-hospital-line"></i></div>
                                 <div class="text-right">          
                                    <h2 class="mb-0"><span class="counter">{{ App\User::where('role', 'Pharmacist')->count()}}</span></h2>
                        ...
                        <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                           <div class="iq-card-body iq-bg-danger rounded">
                              <div class="d-flex align-items-center justify-content-between">
                                 ...
                                 <div class="text-right">                
                                    <h2 class="mb-0"><span class="counter">{{ App\User::where('role', 'Organization')->count()}}</span></h2>
                     ...
                     <div class="col-md-6 col-lg-3">
                        <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                           <div class="iq-card-body iq-bg-danger rounded">
                              <div class="d-flex align-items-center justify-content-between">
                                 <div class="rounded-circle iq-card-icon bg-danger"><i class="ri-briefcase-4-fill"></i></div>
                                 <div class="text-right">                
                                    <h2 class="mb-0"><span class="counter">{{ App\User::where('role', 'HMO')->count()}}</span></h2>
                                    <h5 class="">HMO</h5>
                                 </div>
                              </div>
                           </div>
                     ...
                     <div class="col-md-6 col-lg-3">
                        <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                           <div class="iq-card-body iq-bg-danger rounded">
                              <div class="d-flex align-items-center justify-content-between">
                                 <div class="rounded-circle iq-card-icon bg-danger"><i class="ri-home-8-fill"></i></div>
                                 <div class="text-right">                
                                    <h2 class="mb-0"><span class="counter">{{ App\hospitals::count()}}</span></h2>
                                    <h5 class="">Hospitals</h5>
                                 </div>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                           <div class="iq-card-body iq-bg-danger rounded">
                              <div class="d-flex align-items-center justify-content-between">
                                 <div class="rounded-circle iq-card-icon bg-danger"><i class="ri-group-fill"></i></div>
                                 <div class="text-right">                
                                    <h2 class="mb-0"><span class="counter">{{ App\User::count()}}</span></h2>
      ...
      .right-addon .fa { right: 20px;}
               ...
               <div class="col-lg-12" style="margin-top: 40px;">
                  ...
                  <div class="iq-card iq-card-block iq-card-stretch iq-card-height" style="color:#02818f;">
                   <div class="iq-card-header d-flex justify-content-between">
                      <div class="iq-header-title">
                        <h4 class="card-title" style="color:#02818f;">Users List</h4>
                    </div>
                   </div>
                   @php
               ...
               <div class="col-lg-12" style="margin-top: 40px;">
                  ...
                  <div class="iq-card iq-card-block iq-card-stretch iq-card-height" style="color:#02818f;">
                   <div class="iq-card-header d-flex justify-content-between">
                      <div class="iq-header-title">
                        <h4 class="card-title" style="color:#02818f;">Hospitals List</h4>
                    </div>
                   </div>
                   @php
