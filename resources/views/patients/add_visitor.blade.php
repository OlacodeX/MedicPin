   ...
   <div class="container-fluid">
      <div class="row align-items-center">
         <div class="col-md-12 col-12">
            ...
            <h2 class="breadcrumb-title">Expecting Someone? Register Visitor</h2>
         </div>
      </div>
   </div>
</div>
...
<div class="col-md-7 col-lg-8 col-xl-9">
   <div class="card">
      <div class="card-header">
         <h4 class="card-title"><b>Register Visitor</b></h4>
      ...
      <div class="card-body">
         ...
         {!! Form::open(['action' => 'VisitorController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) /** The action should be the block of code in the store function in PostsController
         **/ !!}
   <div class="row">
      <div class="col-md-6">
       ...
       <input type="text" class="form-control floating" id="pin" name="pin" placeholder="Visitor MedicPin">
      
       <label for="pin" class="focus-label">MedicPin</label> 
      </div>
       </div>
      </div>
      <div class="col-md-6">
       <div class="form-group form-focus">
        ...
        <input type="date" class="form-control floating" name="date" id="date" placeholder="Date of Visit....">
        </div>
        <label for="date" class="focus-label">Date of Visit</label>
       </div>
      </div>
      <hr>
      <button type="submit" class="btn btn-primary" style="margin-left: 20px;">Register Visitor</button>
      {!! Form::close() !!}
   </div>
      </div>
</div>
      ...
      **/ !!}
               ...
               <div class="col-md-6">
                  <div class="form-group form-focus">
                     <div class="inner-addon right-addon">
                         <i class="fa fa-user"></i>
                     <input type="text" class="form-control floating" id="name" name="name" placeholder="Visitor Name">
               ...
               <div class="col-md-6">
                  <div class="form-group form-focus">
                     ...
                     <input type="text" class="form-control floating" id="number" name="number" placeholder="use format '8123xxxxxx'">
