     ...
     <div>
        <div class="">
         ...
         <div class="iq-card-body">
             ...
             <input type="text" class="form-control" id="pin" name="pin" placeholder="Visitor MedicPin">
             </div>
             </div>
             <div class="form-group col-md-6">
            ...
            <div class="iq-card">
               <div class="iq-card-header d-flex justify-content-between">
                  <div class="iq-header-title">
                     <h4 class="card-title">Register Visitor</h4>
                     <h6 class="card-title">Visitor Not On MedicPin?</h6>
                          ...
                          <div class="new-user-info">
                                <div class="row">
                                   ...
                                   <div class="form-group col-md-6">
                                      ...
                                      <input type="text" class="form-control" id="number" name="number" placeholder="use format '8123xxxxxx'">
                                      </div>
                                   </div>
                                   <div class="form-group col-md-6">
                                    <label for="date">Date of Visit</label>
