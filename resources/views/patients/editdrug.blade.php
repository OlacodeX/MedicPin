         ...
         <div class="col-md-12 col-12">
            <nav aria-label="breadcrumb" class="page-breadcrumb">
               <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Edit Drug Details</li>
               </ol>
            </nav>
            <h2 class="breadcrumb-title">Edit Drug Details</h2>
         </div>
      </div>
   </div>
</div>
...
<div class="col-md-7 col-lg-8 col-xl-9">
   <div class="card">
      <div class="card-header">
         <h4 class="card-title"><b>Edit Drug Information</b></h4>
      </div>
      <div class="card-body">
         ...
         <div class="form-group">
               <div class="add-img-user profile-img-edit">
                  <div class="p-image">
                    ...
                    <br><input class="form-control" type="file" accept="image/*" name="img">
                 </div>
               </div>
      ...
      <div class="row">
         ...
         <div class="form-group col-md-6">
            ...
            <select class="form-control" id="selectcat" name="category">
               <option value="{{$drug->category}}">{{$drug->category}}</option>
