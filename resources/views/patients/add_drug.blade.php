         ...
         <div class="col-md-12 col-12">
            <nav aria-label="breadcrumb" class="page-breadcrumb">
               <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Drug Inventory</li>
               </ol>
            </nav>
            <h2 class="breadcrumb-title">Add New Drug</h2>
         </div>
      </div>
   </div>
</div>
...
<div class="col-md-7 col-lg-8 col-xl-9">
   <div class="card">
      <div class="card-header">
         <h4 class="card-title"><b>New Drug Information</b></h4>
      </div>
      <div class="card-body">
        ...
        <div class="col-md-12">
           <div class="form-group">
                    <div class="p-image">
                       <h5 class="upload-button">Drug Cover Image</h5> 
   ...
   <div class="card-body">
                 <div class="row">
                    ...
                    <div class="form-group form-focus">
                       ...
                       <input type="text" class="form-control floating" id="name" name="name" placeholder="Drug Name">
                       </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group form-focus">
                       ...
                       <input type="text" class="form-control floating" id="make" name="make" placeholder="Made by which company?">
                       </div>
                       <label for="mae" class="focus-label">Drug Make:</label>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group form-focus">
                       ...
                       <div class="inner-addon right-addon">
                           <i class="fa fa-bed"></i>
                       <input type="text" class="form-control floating" id="weight" name="weight" placeholder="In milligram (mg)">
                       </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group form-focus">
                       ...
                       <input type="text" class="form-control floating" id="price" placeholder="Specify in Naira" name="price">
                       </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                       <select class="form-control" id="select" name="sell">
                             <option value="N/A">--How do you sell/price?--</option>
