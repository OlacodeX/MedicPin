   ...
   <div class="container-fluid">
      <div class="row align-items-center">
         <div class="col-md-12 col-12">
            ...
            <h2 class="breadcrumb-title">Edit Your Question</h2>
         </div>
      </div>
   </div>
</div>
...
<div class="col-md-7 col-lg-8 col-xl-9">
   <div class="card">
      <div class="card-header">
         <h4 class="card-title"><b>Edit Your Question</b></h4>
      </div>
      <div class="card-body">
         ...
         @endif
         <div class="form-group">
            <label for="identity">--Reveal Your Identity?--</label>
           <select class="form-control mb-0" id="identity" name="identity">
              <option value="{{$question->asker_identity}}">{{$question->asker_identity}}</option>
