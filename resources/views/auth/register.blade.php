                    ...
                    <div class="row align-items-center justify-content-center">
                        ...
                        <div class="col-md-12 col-lg-6 login-right" style="margin-bottom: 20px;">
                            <div class="login-header">
                                <h3>Become A Member of <span>MedicPin</span></h3>
                            </div>
                            ...
                            **/ !!}
                                ...
                                <div class="form-group form-focus">
                                    <div class="inner-addon right-addon">
                                        ...
                                        <input id="name" type="text" class="form-control floating @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" placeholder="Your full name" autofocus>
                            ...
                            <div class="inner-addon right-addon">
                                <i class="fa fa-user"></i>
                                <input id="phone" type="number" class="form-control floating @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" required autocomplete="phone" placeholder="use format '8123xxxxxx'">
                        ...
                        <div class="form-group form-focus">
                            <div class="inner-addon right-addon">
                               <i class="fa fa-date"></i>
                                <input id="age" type="date" class="form-control floating @error('age') is-invalid @enderror" name="age" value="{{ old('age') }}" autocomplete="age" placeholder="How Old Are You?">
